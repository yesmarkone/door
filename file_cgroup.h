 ...
 * after vmlinux.h and the bpf helpers. Lifted verbatim from file.c:831-931, before the split. */
#ifndef DOOR_FILE_CGROUP_H
#define DOOR_FILE_CGROUP_H
